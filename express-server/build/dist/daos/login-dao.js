    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    client = _a.sent();
                    return [4 /*yield*/, client.query("select \"user_id\", \"username\", \"password\", \"first_name\", \"last_name\", \"email\", \"role\" from project0.users u left join  project0.roles r on u.\"role_id\"=r.\"role_id\" where u.\"username\"='" + username + "' and u.\"password\"='" + password + "';")];
                case 2:
                    result = _a.sent();
